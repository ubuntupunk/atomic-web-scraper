...
class WebsiteScraperTool(BaseTool):
    ...
    def __init__(self, config: Optional[WebsiteScraperConfig] = None):
        ...
        if config is None:
            config = WebsiteScraperConfig(base_url="https://example.com")
        ...
        base_config = BaseToolConfig(
            title="Website Scraper Tool",
            description="Configurable website scraper tool that executes planned scraping strategies"
        )
        ...
        logger.info(f"WebsiteScraperTool initialized with config: {config}")
    ...
    def run(self, input_data: WebsiteScraperInputSchema) -> WebsiteScraperOutputSchema:
        ...
        try:
            ...
            return WebsiteScraperOutputSchema(
                results={
    ...
    def _validate_inputs(self, input_data: WebsiteScraperInputSchema) -> None:
        """
    ...
    def get_tool_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'version': '1.0.0',
            'description': 'Configurable website scraper tool built on atomic agents framework',
            'config': {
